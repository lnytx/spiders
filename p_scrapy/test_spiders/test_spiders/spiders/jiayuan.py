...
class jiayuan_data(scrapy.Spider):
    ...
    #http://www.jiayuan.com/175017527?fxly=pmtq-ss-210&pv.mark=s_p_c|175017527|68209968
    start_urls = [
        "http://www.jiayuan.com/175017527?fxly=pmtq-ss-210&pv.mark=s_p_c|175017527|68209968"#直接搜索结果，获取个人主页的url(先不登录)
    ]
    login_url = 'http://login.jiayuan.com/'#登录时的url
    print("self.start_urls[0]",start_urls[0])
...
#             result_dict = {}#多个dict合并后的结果
        ...
        item['image_dir'] = nick_name+'_'+person_id
